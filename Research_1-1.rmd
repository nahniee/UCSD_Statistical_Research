...
calculate_hpd <- function(successes, failures, shape1, shape2, alpha) {
  ...
  objective_function <- function(t) {        
    ...
    prob <- pbeta(right_p, posterior_shape1, posterior_shape2) - pbeta(left_p, posterior_shape1, posterior_shape2)
